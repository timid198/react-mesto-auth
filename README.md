...
Описание: интерактивная страница, куда можно добавлять фотографии, удалять их и ставить лайки. Настроена авторизация идентифицированных пользователей и регистрация не идентифицированных. Работает вход и выход в приложение.
